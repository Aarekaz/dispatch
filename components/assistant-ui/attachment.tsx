...
import { PropsWithChildren, useEffect, useState, type FC, type ReactElement } from "react";
import { FileText, Plus as PlusIcon, X as XIcon } from "@phosphor-icons/react";
import {
  AttachmentPrimitive,
  ComposerPrimitive,
  MessagePrimitive,
...
const useFileSrc = (file: File | undefined) => {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => setSrc(objectUrl), 0);
