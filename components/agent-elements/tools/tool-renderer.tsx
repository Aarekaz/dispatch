...
import type { ToolGroupPart } from "./tool-group";

type ToolRendererPart = {
  type: string;
  id?: string;
  toolCallId?: string;
  state?: string;
...
export type ToolRendererProps = {
  part: ToolRendererPart;
  nestedTools?: ToolRendererPart[];
  chatStatus?: string;
...
export const ToolRenderer = memo(function ToolRenderer({
  ...
  switch (partType) {
    ...
    case "tool-Grep":
    case "tool-Glob":
      return <SearchTool part={part as never} />;
    case "tool-PlanWrite":
      return <PlanTool part={part as never} chatStatus={chatStatus} />;
    case "tool-TodoWrite":
      return <TodoTool part={part as never} chatStatus={chatStatus} />;
    case "tool-Question":
      return (
        <QuestionTool
    ...
    case "tool-Agent":
      ...
      return (
        <ToolGroup
          part={part as ToolGroupPart}
          nestedTools={nestedTools as ToolGroupPart[] | undefined}
          chatStatus={chatStatus}
    ...
    case "tool-Thinking":
      return <ThinkingTool part={part as never} />;
  }
  ...
  if (mcpInfo) {
    ...
    return (
      <McpTool part={part as never} mcpInfo={mcpInfo} chatStatus={chatStatus} />
    );
  }
