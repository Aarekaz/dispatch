...
function summarizeNestedTools(nestedTools: ToolGroupPart[]): string {
...
function getNestedCounts(nestedTools: ToolGroupPart[]) {
  const fileTypes = new Set(["tool-Read", "tool-Edit", "tool-Write"]);
  const searchTypes = new Set([
    "tool-Search",
    "tool-Grep",
