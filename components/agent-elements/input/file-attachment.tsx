  ...
  return (
    ...
    >
      {isImageOnly ? (
        <div
          className={cn(
            "relative size-8 overflow-hidden shrink-0 rounded-[calc(var(--an-input-border-radius)-var(--an-context-padding)-2px)]",
        ...
        <>
          {isImage && url ? (
            <div
              className={cn(
                "relative w-8 self-stretch overflow-hidden shrink-0 rounded-[calc(var(--an-input-border-radius)-var(--an-context-padding)-2px)]",
                canPreview && "cursor-pointer",
              )}
              onClick={canPreview ? openLightbox : undefined}
            >
